...
describe('Valiadte DocType Functional Testing ', () => {
    ...
    it('Test Scenario 1] To click Next Button To Navigate "Valiadte DITA Source" Field', () => {
      ...
      //Test Case To click Next Button To Navigate "Valiadte DITA Source" Field
        cy.xpath('//button[@id="DocTypeValiBtn"]').contains("Validate DocType")
        cy.xpath('//button[text()=" Next "]').click()
        cy.wait(5000)
      
     // To check progress bar Functionality 

     cy.xpath('//h3[text()="Error"]').contains()
     //div[@role='alert']
